      ...
      <div className="row mb-5">
        <div className="col-lg-8 mx-auto text-center">
          ...
          <p className="small text-muted px-4">
            ...
            for quality products. Our journey has been driven by our commitment to
            customer satisfaction and our passion for delivering excellence.
          </p>
        </div>
      </div>
          ...
          <div className="card h-100 border-0 shadow-sm">
            <div className="card-body p-4">
              ...
              <p className="small text-muted px-2">
                ...
                ensuring a seamless and enjoyable shopping experience. We believe
                in building lasting relationships with our customers through
      ...
      <div className="row">
        <div className="col-lg-8 mx-auto text-center">
          ...
          <p className="small text-muted px-4">
            ...
            From our carefully curated product selection to our responsive customer service,
            every aspect of our business is designed with you in mind. We value your trust
            and are committed to maintaining the highest standards in everything we do.
          </p>
        </div>
      </div>
    </div>
